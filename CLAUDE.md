...
| Golden | **GOLDEN-SK-Sphere-001** — 10,000 ticks from (0°,0°), ψ=45°, TAS=250 m/s → world_hash matches cross-toolchain (12 sealed goldens total; see SEAL_CARD) |
...
- next — free pick (none blocking): **B5** ISA atmosphere (a seal); bounded/windowed catch-up for
  open-ended live streams (layer 13's named boundary); or per-airframe region toughness follow-ups
  (e.g. an A6M2 engine retune — its own data-only seal that moves EngineOut-001's story).
