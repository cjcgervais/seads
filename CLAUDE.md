...
- next — free pick (none blocking): more netcode (layer 15b — input upstreaming, the first
  bidirectional layer; a canonical tick-stamped command queue into the authoritative kernel); or
  more renderer polish.
