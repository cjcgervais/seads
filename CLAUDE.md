...
- next — free pick (none blocking): per-airframe toughness / σ / crit-alt surfaced in the HUD
  (presentation-only); a per-airframe two-speed blower schedule (deferred at v1.22r0 — doubles
  the data surface for a second-order kink); or more netcode (layer 15 — e.g. a
