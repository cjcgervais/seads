...
- next — free pick (none blocking): more netcode (layer 15 — e.g. a heartbeat/timeout LEAVE for
  silently-dead clients, or input upstreaming); or more renderer polish.
