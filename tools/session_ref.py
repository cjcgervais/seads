...
def _build_server_kernel(scenario):
    ...
    for ac in scenario["aircraft"]:
        ...
        a.engine_hp = env["engine_frac"] * a.hp  # v1.18r0: re-derive region sub-pools from the
        a.wing_hp = env["wing_frac"] * a.hp      # per-airframe hp; v1.20r0: the envelope's region-
        a.tail_hp = env["tail_frac"] * a.hp      # toughness fractions (matches build_scenario)
