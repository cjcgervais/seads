...
| *(pending seal)* | `36ee936e9` | **THE KERNEL RECONCILIATION** (2026-07-24): `flight-kernel-v5` merged into the tunnel game — tunnels, ballistics, Sudbury world, Bf 109 fleet, bandits all on v5. Reconcile merge `46051ca23` (gate 793/793) + fly-round fixes through `36ee936e9` (gate 797/797): rung F dive approved ("the dive is perfect"), recorder auto-saves on window close (no second F9), brakes approved ("good enough for the field in front of your house when you were five"). FIRST LANDING ever put down on Sudbury clay — the v1 constitution said "no landing." Two bandits downed on v5 physics. Open item: prop strike on taxi (suspect: brake pitch-down on rough clay). Fly verdict: **"better than all the rest."** Branch `sandbox/kernel-v5-reconcile`, pushed. Seals into `main` on Chad's word "merge." |
